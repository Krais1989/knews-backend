...
namespace KNews.Core.Services.Members.Validators
{
    ...
    /// </summary>
    public class MemberInviteCommunityValidatorDto
    {
        ...
        public MemberInviteCommunityValidatorDto(
    ...
    /// </summary>
    public class MemberInviteCommunityValidator : AbstractValidator<MemberInviteCommunityValidatorDto>
    {
        public MemberInviteCommunityValidator()
        {
