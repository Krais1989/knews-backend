...
{
    public class CommunityGetShortValidatorTest
    {
        [Test, TestCaseSource(nameof(ValidationCases))]
        public void GetShortValidation(CommunityGetShortValidatorDto validatorDto, bool verify)
        {
        ...
        static IEnumerable<TestCaseData> ValidationCases
        {
            get
            {
                yield return new TestCaseData(new CommunityGetShortValidatorDto
                {
                    CommunityStatus = ECommunityStatus.Approved
                }, true);
                yield return new TestCaseData(new CommunityGetShortValidatorDto
                {
                    CommunityStatus = ECommunityStatus.Deleted
                }, false);
            }
        }
    }
